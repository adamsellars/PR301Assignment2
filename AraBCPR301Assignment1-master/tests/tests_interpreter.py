...
>>> controller = InterpreterController(ClassFinder(), ConsoleView())
>>> cmd = CommandLineInterpreter(controller)
>>> cmd.do_greet("line")
==================================================
...
==================================================
Description: Load a .txt file from controller directory into the program
Syntax: load_file [file_name]
Parameter: [file_name] = name of text file inside controller
Example: load_file plant.txt
<BLANKLINE>
...
==================================================
Description: Print loaded plant txt file into PEP8 format into the interpreter
Syntax: print_file
Example: print_file
<BLANKLINE>
...
==================================================
Description: write a PEP8 format .py files into directory 'generated_code' in the controller directory
Syntax: write_file
Example: write_file
<BLANKLINE>

# Test 12 try to read protected file should get permission error message
# Need to create a file with no write or read permission called no_permission.txt
...
------------------------------------------------------
Press 4 to write file to database (load a file first)
------------------------------------------------------
...
Press 6 to load text file, convert data to PEP8 python
        ...
        same directory
------------------------------------------------------
Press 7 to load data from pickle file (file in controller)
------------------------------------------------------
Press 8 to exit
------------------------------------------------------
<BLANKLINE>
...
from controller.interpreter_controller import CommandLineInterpreter
